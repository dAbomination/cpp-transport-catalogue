...
namespace json {
    ...
    struct NodeTypeChecker {
        NodeType operator()(std::nullptr_t) const;
        NodeType operator()(int) const;
        NodeType operator()(double) const;
        NodeType operator()(bool) const;
        NodeType operator()(Array) const;
        NodeType operator()(Dict) const;
        NodeType operator()(std::string) const;
    }; 
